void Setting() {
  ...
  RefCenterLineValue(900);  // ค่า threshold เซนเซอร์คู่กลาง
...
void SetKpKd() {
  ...
  Set_KP_KD(SPD_20,  0.007, 0.07);  // ความเร็ว 20
  Set_KP_KD(SPD_30,  0.011, 0.11);  // ความเร็ว 30
  Set_KP_KD(SPD_40,  0.012, 0.12);  // ความเร็ว 40
  Set_KP_KD(SPD_50,  0.015, 0.15);  // ความเร็ว 50
  Set_KP_KD(SPD_60,  0.024, 0.24);  // ความเร็ว 60
  Set_KP_KD(SPD_70,  0.021, 0.21);  // ความเร็ว 70
...
void SetKpKdBack() {
  ...
  Set_KP_KD_Back(SPD_60,  0.025, 0.40);  // ความเร็ว 60
